...
// Routes
router.post('/', isAuthenticated, clientValidation, clientController.createClient);
router.get('/', isAuthenticated, clientController.getClients);
router.put('/:id', isAuthenticated, clientValidation, clientController.updateClient);
